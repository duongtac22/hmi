<template>
    <form id="" class="justify-center items-center w-full bg-white px-6 flex flex-col lg:w-1/2 xl:w-1/3 m-auto">
        <h2 class="text-2xl my-4">Đăng nhập</h2>
        <div id="" class="w-full p-2 justify-start flex flex-col">
            <div id="whoobe-7izhv" class=" flex flex-row">
                <span id="" class="z-highest rounded-l-lg w-10 h-10 flex justify-center items-center text-2xl text-gray-400 border border-r-0" mode="render" block="">
                ...
                <input value="" class="border border-gray-200 rounded-r-lg outline-none focus:ring-1 ring-blue-400 w-full pl-1" id="" name="" required="false" placeholder="username">
            </div>
            
            <div id="" class="my-4 flex flex-row">
                <span id="" class="z-highest rounded-l-lg w-10 h-10 flex justify-center items-center text-2xl text-gray-400 border border-r-0" mode="render" block="">
                ...
                <input type="password" value="" class="h-10 border border-gray-200 rounded-r-lg outline-none focus:ring-1 ring-blue-300 w-full pl-1" id="" name="" placeholder="password" required="false">
            </div>
            <button value="button" class="px-4 py-2 rounded bg-blue text-white my-4 w-full" id="">Đăng nhập</button>
        </div>
    </form>
</template>
